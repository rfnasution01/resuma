...
const __filename = fileURLToPath(import.meta.url) // Get the full path of the current file from import.meta.url
const __dirname = path.dirname(__filename) // Get the directory name from the full file path
